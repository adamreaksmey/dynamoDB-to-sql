...
import subjects from "./log/subjects/subject.mjs"
...
const main = () => {
  ...
  const queries = insert_data(subjects);
  const subjectSqlContent = queries.join("\n");

  fs.writeFileSync("./generated_sql/subjects/subject.sql", subjectSqlContent);
